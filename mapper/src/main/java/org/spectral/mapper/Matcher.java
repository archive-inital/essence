...
public class Matcher {
	...
	private final double absClassAutoMatchThreshold = 0;
	private final double relClassAutoMatchThreshold = 0;
	private final double absMethodAutoMatchThreshold = 0;
	private final double relMethodAutoMatchThreshold = 0;
	private final double absFieldAutoMatchThreshold = 0;
	private final double relFieldAutoMatchThreshold = 0;
	private final double absMethodArgAutoMatchThreshold = 0;
	private final double relMethodArgAutoMatchThreshold = 0;
	private final double absMethodVarAutoMatchThreshold = 0;
	private final double relMethodVarAutoMatchThreshold = 0;
