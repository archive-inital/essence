...
public class FieldClassifier {
	...
	public static List<RankResult<FieldInstance>> rank(FieldInstance src, FieldInstance[] dsts, ClassifierLevel level, OldClassEnvironment env) {
		return rank(src, dsts, level, env, Double.POSITIVE_INFINITY);
	}

	public static List<RankResult<FieldInstance>> rank(FieldInstance src, FieldInstance[] dsts, ClassifierLevel level, OldClassEnvironment env, double maxMismatch) {
	...
	private static AbstractClassifier fieldTypeCheck = new AbstractClassifier("field type check") {
		@Override
		public double getScore(FieldInstance fieldA, FieldInstance fieldB, OldClassEnvironment env) {
	...
	private static AbstractClassifier signature = new AbstractClassifier("signature") {
		@Override
		public double getScore(FieldInstance fieldA, FieldInstance fieldB, OldClassEnvironment env) {
			Signature.FieldSignature sigA = fieldA.getSignature();
			Signature.FieldSignature sigB = fieldB.getSignature();
