...
public class ClassifierUtil {
	...
	public static double compareInsns(List<AbstractInsnNode> listA, List<AbstractInsnNode> listB, OldClassEnvironment env) {
	...
	private static <T> boolean compareInsns(AbstractInsnNode insnA, AbstractInsnNode insnB, T listA, T listB, ToIntBiFunction<T, AbstractInsnNode> posProvider,
                                            MethodInstance mthA, MethodInstance mthB, OldClassEnvironment env) {
	...
	private static boolean compareMethods(String ownerA, String nameA, String descA, boolean toIfA, String ownerB, String nameB, String descB, boolean toIfB, OldClassEnvironment env) {
	...
	public static int[] mapInsns(InsnList listA, InsnList listB, MethodInstance mthA, MethodInstance mthB, OldClassEnvironment env) {
	...
	public static <T extends Matchable<T>> List<RankResult<T>> rank(T src, T[] dsts, Collection<IClassifier<T>> classifiers, BiPredicate<T, T> potentialEqualityCheck, OldClassEnvironment env, double maxMismatch) {
	...
	public static <T extends Matchable<T>> List<RankResult<T>> rankParallel(T src, T[] dsts, Collection<IClassifier<T>> classifiers, BiPredicate<T, T> potentialEqualityCheck, OldClassEnvironment env, double maxMismatch) {
	...
	private static <T extends Matchable<T>> RankResult<T> rank(T src, T dst, Collection<IClassifier<T>> classifiers, BiPredicate<T, T> potentialEqualityCheck, OldClassEnvironment env, double maxMismatch) {
	...
	private static final MatchingCache.CacheToken<int[]> ilMapCacheToken = new MatchingCache.CacheToken<>();
}
