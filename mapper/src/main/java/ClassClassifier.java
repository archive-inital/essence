...
public class ClassClassifier {
	...
	public static List<RankResult<ClassInstance>> rank(ClassInstance src, ClassInstance[] dsts, ClassifierLevel level, OldClassEnvironment env, double maxMismatch) {
	...
	public static List<RankResult<ClassInstance>> rankParallel(ClassInstance src, ClassInstance[] dsts, ClassifierLevel level, OldClassEnvironment env, double maxMismatch) {
	...
	private static AbstractClassifier classTypeCheck = new AbstractClassifier("class type check") {
		@Override
		public double getScore(ClassInstance clsA, ClassInstance clsB, OldClassEnvironment env) {
	...
	private static AbstractClassifier signature = new AbstractClassifier("signature") {
		@Override
		public double getScore(ClassInstance clsA, ClassInstance clsB, OldClassEnvironment env) {
			Signature.ClassSignature sigA = clsA.getSignature();
			Signature.ClassSignature sigB = clsB.getSignature();
