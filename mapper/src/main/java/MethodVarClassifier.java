...
public class MethodVarClassifier {
	...
	public static List<RankResult<MethodVarInstance>> rank(MethodVarInstance src, MethodVarInstance[] dsts, ClassifierLevel level, OldClassEnvironment env, double maxMismatch) {
	...
	private static AbstractClassifier type = new AbstractClassifier("type") {
		@Override
		public double getScore(MethodVarInstance argA, MethodVarInstance argB, OldClassEnvironment env) {
	...
	private static AbstractClassifier position = new AbstractClassifier("position") {
		@Override
		public double getScore(MethodVarInstance methodA, MethodVarInstance methodB, OldClassEnvironment env) {
